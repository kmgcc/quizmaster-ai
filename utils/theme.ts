...
export const themes: Record<ThemePalette, { light: ThemeTokens; dark: ThemeTokens }> = {
  teal_elegant: {
    light: {
      ...
      surface: 'hsl(60, 34.80%, 96.90%)',
      surface2: 'hsl(60, 100.00%, 98.60%)',
      outline: 'hsl(62, 33.30%, 84.10%)',
      text: 'hsl(0, 0%, 10%)',
      muted: 'hsl(0, 0%, 45%)',
  ...
  sky_slate: {
    ...
    dark: {
      ...
      surface2: 'hsl(210, 12%, 10%)',
      outline: 'hsl(212, 11.90%, 21.40%)',
      text: 'hsl(0, 0%, 95%)',
      muted: 'hsl(0, 0%, 60%)',
      primary: 'hsl(200, 25%, 58%)',
      onPrimary: 'hsl(0, 0%, 10%)',
      primaryContainer: 'hsl(210, 25.60%, 16.90%)',
  ...
  sunlit_yellow: {
    ...
    dark: {
      ...
      primaryContainer: 'hsla(38, 21.30%, 17.50%, 0.85)',
  ...
  parchment_pale: {
    ...
    dark: {
      bg: 'hsl(30, 6.30%, 6.30%)', // 极低饱和暖暗色相
      surface: 'hsl(30, 3.40%, 11.40%)',
      surface2: 'hsl(60, 4.10%, 14.30%)',
      outline: 'hsl(37, 6.50%, 24.30%)',
      text: 'hsl(40, 10%, 95%)',
      muted: 'hsl(40, 8%, 60%)',
      primary: 'hsl(42, 12.20%, 61.60%)',
      onPrimary: 'hsl(40, 8%, 8%)',
      primaryContainer: 'hsl(43, 6.70%, 20.60%)',
      onPrimaryContainer: 'hsl(42, 18%, 85%)',
      secondary: 'hsl(50, 11.20%, 59.80%)',
      onSecondary: 'hsl(40, 8%, 8%)',
      secondaryContainer: 'hsl(40, 6.00%, 19.60%)',
